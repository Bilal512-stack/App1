...
export default function SignupScreen(){
    ...
    return (
        <View className="bg-white h-full w-full">
            ...
            <Image className="h-full w-full absolute" source={require('../../assets/images/2.jpg')}/>

            {/* lights */}
            <View className="flex-row justify-around w-full absolute">
                <Animated.Image entering={FadeInUp.delay(200).duration(1000).springify()} className="h-[225] w-[90]" source={require('../../assets/images/2.jpg')}/>
                <Animated.Image entering={FadeInUp.delay(200).duration(1000).springify()} className="h-[225] w-[90]" source={require('../../assets/images/2.jpg')}/>
            </View>
                ...
                <View className="flex items-center mx-4 space-y-4">
                    ...
                    <Animated.View entering={FadeInDown.delay(600).duration(1000).springify()} className="w-full">
                        <TouchableOpacity
                            ...
                            <Text className="text-xl font-bold text-white text-enter">SignUp</Text>
                        </TouchableOpacity>
                    </Animated.View>
